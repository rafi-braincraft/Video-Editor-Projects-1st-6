...
class WaterfallLayout: UICollectionViewLayout {
    ...
    var pagingViewHeight : CGFloat = 44
    ...
    override func prepare() {
        ...
        if numberOfItems > 0 {
            ...
            pagingViewAttributes.frame = CGRect(x: 0, y: contentHeight, width: collectionView.frame.width, height: pagingViewHeight)
            self.pagingViewAttributes = pagingViewAttributes

            contentHeight += pagingViewHeight
        } else {
