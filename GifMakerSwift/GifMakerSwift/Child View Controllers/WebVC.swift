...
extension WebVC: UICollectionViewDelegate, UICollectionViewDataSource, UICollectionViewDelegateFlowLayout {
...
extension WebVC: UICollectionViewDataSourcePrefetching {
